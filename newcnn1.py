...
# # load dataset
# x_dataset, y_dataset = read_dataset(r"C:\Users\user\OneDrive\Desktop\Quick sort\quick_fix_sorter\static\dataset")
...
def predictcnn(fn):
    ...
    mo = load_model(r"C:\Users\user\OneDrive\Desktop\Quick sort\quick_fix_sorter\static\model1.h5")
    dataset/=255
...
print(predictcnn(r"C:\Users\user\OneDrive\Desktop\Quick sort\quick_fix_sorter\static\dataset\G\images (2).jpg"))